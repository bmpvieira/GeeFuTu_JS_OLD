...
module.exports.controller = function (app) {
    ...
    app.get('/:username/:organism/edit', [AuthController.isAuthenticated, AuthController.canEdit],
        function (req, res) {
    ...
    app.post('/:username/:organism/edit', [AuthController.isAuthenticated, AuthController.canEdit], function (req, res) {
        var user = req.user;
